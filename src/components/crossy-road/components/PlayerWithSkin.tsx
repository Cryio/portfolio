...
import { getSelectedSkin } from '../stores/skins';

export function PlayerWithSkin() {
    ...
    <group ref={player}>
      <group position-z={15}>
        ...
        <mesh position={[-11, 0, 10]} castShadow>
          ...
          <meshLambertMaterial color={skin.wingColor} />
        </mesh>
        <mesh position={[11, 0, 10]} castShadow>
          <boxGeometry args={[6, 14, 12]} />
          <meshLambertMaterial color={skin.wingColor} />
        ...
        <mesh position={[0, 12, 14]} castShadow>
          ...
          <meshLambertMaterial color={skin.beakColor} />
        </mesh>
        
        {/* Comb */}
        <mesh position={[0, 0, 25]} castShadow>
          <boxGeometry args={[6, 6, 8]} />
          <meshLambertMaterial color={skin.combColor} />
        </mesh>
        ...
        <mesh position={[-5, 8, 0]}>
          ...
          <meshLambertMaterial color={skin.feetColor} />
        </mesh>
        <mesh position={[5, 8, 0]}>
          <boxGeometry args={[4, 10, 3]} />
          <meshLambertMaterial color={skin.feetColor} />
