...
technologies: [
  {
    ...
    items: [
      ...
      { name: "DFIR-IRIS", logo: technologyLogos.dfirIris, alt: "DFIR-IRIS Logo", description: "An open-source platform for collaborative digital forensics and incident response, helping teams manage and investigate security cases efficiently." },
