...
export const projects = [
  {
    ...
    tech: ["Python", "ESP32", "TensorFlow", "GANs", "NumPy"],
  ...
  },
  {
    ...
    tech: ["Docker", "Podman", "Python", "C", "Security"],
    github: "https://github.com/Cryio",
    featured: true,
    type: "security",
  },
  {
    ...
    tech: ["Flutter", "Dart", "OAuth", "Firebase"],
    github: "https://github.com/Cryio",
    featured: true,
    type: "mobile",
  },
  {
    title: "Healthmate",
    description: "Built with Flask to serve AI-generated text via a REST API. Utilizes the Meta-Llama 3.1 8B model from Hugging Face for text generation. Containerized using Docker, with a pre-cached model to save bandwidth.",
    tech: ["Python", "Flask", "Docker", "Hugging Face", "LLaMA"],
