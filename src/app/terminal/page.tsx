...
const COMMANDS: Record<string, CommandDefinition> = {
  ...
  experience: {
    ...
    execute: () => [
      ...
      "│ Work Experience                       │",
      "└───────────────────────────────────────┘",
      "Platform Engineer | Xcaliber Health",
      "Bangalore, Karnataka | June 2026 – Present",
      "- Converted from intern to full-time Platform Engineer on the core data platform team",
      "- Design and operate CDC and data-sync pipelines (Kafka, Debezium, Ray, Temporal)",
      "- Build platform capabilities: data catalog, lineage, and distributed data-quality validation",
      "- Drive reliability, security, and observability across orchestration and infrastructure",
      "",
      "Engineering Intern | Xcaliber Health",
      "Bangalore, Karnataka | March 2026 – June 2026",
      "- Developed scalable CDC and Data Sync pipelines using Kafka, Debezium, Ray, and Temporal",
      "- Built Data Catalog, Lineage, and Analytics platform features",
      "- Implemented distributed Data Quality validation using Daft and Ray",
      "",
      "CyberSecurity Intern | Fluidech IT Services",
      "Gurugram, Haryana | July 2025 – March 2026",
      "- Monitored security alerts and endpoint logs to identify suspicious activity",
      ...
      "- Integrated external threat intelligence feeds into security workflows",
      "",
      "Junior Web Designer | Maa Karmaa Global Engineering LLP",
      "Kalyan, Maharashtra | Apr – Sep 2023",
      ...
      "- Collaborated with cross-functional teams on responsive design solutions",
      "",
